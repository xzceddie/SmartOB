...
TEST_CASE( "test_SmartOrderBook_async_2(new-level-within-spread)", "1" )
{
    ...
    std::string s8{"S 2 3 1.2 100 1.3 150 1.35 50 1.4 50 1.5 100"};
    std::string t0{"T 0 1.35 50"};           // This is the first trade order that happens

    std::string o9{"N 8 0 50 1.35"};
    std::string s9{"S 3 2 1.2 100 1.3 150 1.4 50 1.3 250 1.5 100"};
    std::string t1{"T 0 1.35 50"};

    std::string o10{"N 9 0 10 1.4"};
    std::string s10{"S 3 2 1.2 100 1.3 150 1.35 150 1.4 40 1.5 100"};
    std::string t2{"T 0 1.4 10"};

    std::string o11{"N 10 0 200 1.35"};
    std::string s11{"S 3 2 1.2 100 1.3 150 1.35 200 1.4 40 1.5 100"};
...
TEST_CASE( "test_SmartOrderBook_async_3(snapshot_leads)", "1" )
{
    spdlog::set_level(spdlog::level::debug);
    std::string o1("N 0 1 100 1.5");
    std::string s1{"S 0 1 1.5 100"};
    ...
    spdlog::debug("[test_SmartOrderBook, 1] SmartOrderBook when snapshot leads: \n{}",
                    SmartOB.getLeaderBook()->toString()
                 );
...
TEST_CASE( "test_SmartOrderBook_async_3(order in the lead)", "1" )
{
    spdlog::set_level(spdlog::level::debug);
    std::string o1("N 0 1 100 1.5");
    std::string s1{"S 0 1 1.5 100"};
    ...
    spdlog::debug("[test_SmartOrderBook, 1] SmartOrderBook when order leads: \n{}",
                    SmartOB.getLeaderBook()->toString()
                 );
